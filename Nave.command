...
start()
{
		...
		clear
	    echo -e  ${yellow}"*****************************************"
		echo -e  ${blue}" # Nave Command 🛸 | www.naveproject.tk            "
...
update_navecommd()
{
	...
	sudo curl -o /usr/local/bin/nave https://raw.githubusercontent.com/hibrunofilho/Nave-Command/main/tools/nave && chmod +x /usr/local/bin/nave && nave
	echo -e ""
}
...
import_macOS(){
	...
	curl -L -s -o /tmp/utilitarios/Install.sh https://raw.githubusercontent.com/hibrunofilho/Nave-Command/main/tools/Install.txt
